...
car8 = Car.create!(description: " A stunning example in one of the rarest colours- a true eye catcher (Limited edition of 500 cars are the very last of production of this remarkable generation of naturally aspirated v8 M cars", price: 220,  year: 2013, doors: 2, transmission: "automatic", seats: 4, model: "M3", kind: "Diesel", brand: "BMW", user: user1)
